...
import heroAnimation from "../assets/hero-painter.json"; // download json from lottiefiles
...
const HomePage = () => {
  ...
  return (
    <div className="bg-background text-textDark">
      {/* Hero Section */}
      <section className="flex flex-col md:flex-row items-center justify-between px-8 md:px-16 py-20 bg-gradient-to-r from-primary to-secondary text-white">
        <motion.div
      ...
      {/* Search Section */}
      <section className="px-8 md:px-16 py-12 bg-white shadow-sm">
        <div className="max-w-3xl mx-auto flex flex-col md:flex-row gap-4">
          ...
          />
          <select className="flex-1 border border-gray-300 p-3 rounded-lg">
      ...
      {/* How It Works */}
      <section className="px-8 md:px-16 py-16 bg-background">
      ...
      <footer className="bg-primary text-white py-8 text-center">
        <p>© 2025 Painter Booking. All rights reserved.</p>
